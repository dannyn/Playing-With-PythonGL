...
class Scene:
    ...
    def __init__(self):
        ...
        #self.m.getVertexArray()
        self.vertexData = [0.25,  0.25, -1.25, 1.0,
            0.25, -0.25, -1.25, 1.0,
            -0.25,  0.25, -1.25, 1.0,
            0.25, -0.25, -1.25, 1.0,
            -0.25, -0.25, -1.25, 1.0,
    ...
    def update(self, dt):
        ...
        self.mMatrix = self.mMatrix * getTranslationMatrix(-1.0, -1.5, -5.0)
    ...
    def render(self):
        ...
        glVertexAttribPointer(1,4,GL_FLOAT, GL_FALSE, 0, c_void_p(len(self.vertexData)/2))
